...
export const RESOURCES: Record<string, Resource> = {
  ...
  circuits: {
    ...
    fields: [
      ...
      { name: "laps", label: "Vueltas (carrera de la liga)", type: "number" },
      { name: "turns", label: "Curvas", type: "number" },
      { name: "description", label: "Descripción", type: "textarea" },
      { name: "lap_record_time", label: "Récord de vuelta (real)", type: "text", help: "ej: 1:15.484" },
      { name: "lap_record_holder", label: "Récord · piloto", type: "text" },
      { name: "lap_record_year", label: "Récord · año", type: "number" },
      { name: "lap_record_car", label: "Récord · auto", type: "text", help: "ej: Mercedes W11" },
    ],
  },
